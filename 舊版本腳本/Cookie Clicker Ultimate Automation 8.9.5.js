...
// @description:zh-TW 全功能自動掛機腳本 v8.9.5 Fortune Cookie Ticker
...
(function() {
    ...
    const Core = {
        ...
        init: function() {
            Logger.success('Core', 'Cookie Clicker Ultimate v8.9.5 Loading...');
