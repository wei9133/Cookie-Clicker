...
// @description:zh-TW 全功能自動掛機腳本 v9.0.1 Fortune Cookie Ticker
...
v9.0.1 Optimization (2026):
  - [Algorithm] Stock Market: 導入動態門檻演算法 (Dynamic Thresholds)，依據經紀人數量動態調整買賣係數，大幅提升獲利效率。
...
v8.9.9.2 Hotfix (2026):
  - [Fix] Garden Protection: 修復花園保護/戒嚴協議解除時，未正確還原「自動突變」開關的 Bug。現在會記憶並恢復原始狀態，防止漏收新品種種子。
v8.9.9.1 Rebuild (2026):
  - [UI] Settings: 新增設定匯出/匯入功能 (位於設定頁籤)，方便跨裝置遷移。
  - [Security] Store: 強化商店購買安全邏輯，嚴格禁止透過通用購買模組操作 Toggle 物品。
  - [Hotfix] Elder Pledge: 修復季節物品所有權檢查邏輯，防止在未獲得該季節掉落物時誤買誓約。
  - [Verification] Season: 確認情人節 ID 列表完整性。
*/
...
(function() {
    ...
    const Core = {
        ...
        init: function() {
            Logger.success('Core', 'Cookie Clicker Ultimate v9.0.1 Loading...');
