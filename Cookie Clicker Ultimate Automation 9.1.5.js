...
// @description:zh-TW 全功能自動掛機腳本 v9.1.5 Persistence & Hotkeys
...
(function() {
    ...
    const Config = {
        ...
        Settings: {
            ...
            // [v9.1.5] Force Mutation Hotkey
            ForceMutationHotkey: GM_getValue('forceMutationHotkey', '^+M')
        },
        // 記憶
        Memory: {
            GardenProfiles: null,
                        ...
                        <div id="tab-garden" class="cc-tab-pane">
                            <div class="panel-section" style="margin-bottom:15px; padding:10px; background:#e8f5e9; border-radius:8px;">
                                ...
                                <label style="display:block; margin-bottom:8px; font-weight:bold; color:#d84315;">
                                    ...
                                    style="width:60px; font-size:10px; margin-left:5px; background:#333; color:#d500f9; border:1px solid #d500f9; border-radius:3px;" 
                                    title="強制開啟變異熱鍵 (AHK 用)">
                                </label>
                                <label style="display:block; margin-bottom:8px; font-weight:bold; color:#1565c0;">
...
// ═══════════════════════════════════════════════════════════════
    ...
    const Logic = {
        ...
        EmergencyForceMutation: function() {
            ...
            // 5. UI Synchronization (The Critical Part - Force Override)
            
            // 5.1 Sync Main Panel Checkboxes
            $('#chk-spending-lock').prop('checked', false);
            $('#chk-garden-mutation').prop('checked', true);

            // 5.2 Force Refresh specific UI Elements
            ...
            Logger.critical('Manual', '☢️ 強制熱鍵執行：已解鎖資金並強制開啟變異 (AHK)');
        }
    };
    ...
    const Core = {
        ...
        init: function() {
            Logger.success('Core', 'Cookie Clicker Ultimate v9.1.5 Loading...');
